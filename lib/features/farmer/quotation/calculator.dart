      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Text(
              'AGRIFLOCK 360 · EPOULTRY',
              style: TextStyle(color: kGreen200, fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.6),
            ),
          ),
          ...
          const Text(
            ...
            style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: kGreen900, height: 1.25),
          ),
          const SizedBox(height: 6),
          const Text(
            'Type your inputs — get your quotation & profit estimate instantly',
            textAlign: TextAlign.center,
